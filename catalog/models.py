...
class Book(models.Model):
    ...
    # simplification - Books assumed to have single author.
...
class BookInstance(models.Model):
    ...
    """
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, help_text = "Unique ID for this copy of the book.")
...
class Author(models.Model):
    ...
    def get_absolute_url(self):
        """
        Returns the url to accessa particular author.
        """
